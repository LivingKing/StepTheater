        ...
        return (
            <Fragment>
                ...
                <SafeAreaView style={styles_detail.detail}>
                    ...
                    <View style={[styles_detail.detail_title2, { justifyContent: "space-between" }]}>
                        <IconButton
                            size={windowWidth / 13}
                            icon="chevron-left"
                            color="#555555"
                                ...
                                >
                                    {dayItem != undefined
                                        ? dayItem.routes.map((route, index) => {
                                            if (route.routeItems.length != 0 && route.routeItems.length != 1) {
                                                let svgMinX;
                                                let svgMinY;
                                                let svgMaxX;
                                                let svgMaxY;
                                                ...
                                                const svgPoint = route.routeItems
                                                    .map(
                                                        (p) =>
                                                            `${[
                                                                p.latitude
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        <View style={{ width: "100%", height: "100%", paddingLeft: windowWidth / 20, }}>
                                                            <Text style={{
