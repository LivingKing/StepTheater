...
const styles = StyleSheet.create({
  ...
  com_safeView_title_route_total_content_text3: { fontSize: 20, fontFamily: "NotoRegular", textAlign: "center", },
  com_safeView_title_route2: { marginTop: 10, flex: 0.5, backgroundColor: "white", justifyContent: "center", },
  com_safeView_title_route_total3: { flex: 1.1, backgroundColor: "white", flexDirection: "row", justifyContent: "space-between", paddingLeft: 25, },
  route_safeView_contents_tool_button: { backgroundColor: "white", width: "100%", borderRadius: 50, },
  route_safeView_contents_tool_button_label: {},
  surface: { width: 100, height: 100, borderRadius: 50, alignItems: "center", justifyContent: "center", elevation: 4, backgroundColor: "yellow", },
  surface4: { width: 70, height: 50, borderRadius: 50, margin: 40, alignItems: "center", justifyContent: "center", elevation: 4, },
  route_safeView_contents_tool_record_buttonaaa: { justifyContent: "center", },
  route_safeView_contents_tool_record: { width: "100%", height: 90, position: "absolute", top: "82%", flexDirection: "row", justifyContent: "space-between", },
  route_safeView_contents_tool_record2: { width: "100%", position: "absolute", top: "10%", flexDirection: "row", justifyContent: "space-between", },
  route_safeView_contents_tool_record_button: { backgroundColor: "white", },
  route_safeView_contents_tool_record_buttonbbb: { backgroundColor: "white", fontSize: 30, },
  circle: { width: 30, height: 30, borderRadius: 30 / 2, backgroundColor: "white", marginTop: 2, marginLeft: 2, transform: [{ rotate: "45deg" }], },
  circle2: { width: 34, height: 34, backgroundColor: "white", borderTopLeftRadius: 17, borderTopRightRadius: 17, borderBottomRightRadius: 17, },
  circle_shadow: { width: 34, height: 34, backgroundColor: "white", borderTopLeftRadius: 17, borderTopRightRadius: 17, borderBottomRightRadius: 17, transform: [{ rotate: "-45deg" }], alignItems: "center", justifyContent: "center", elevation: 10, },
  com_safeView_route: { flex: 1, backgroundColor: "white", },
  ababab: { width: "93%", height: "93%", backgroundColor: "black", borderRadius: 15, alignItems: "center", },
  route_safeView_route_contents_map: { width: "100%", height: "100%", borderRadius: 15, },
  route_safeView_route_contents_map2: { width: "100%", height: "100%", },
  surface2: { width: "94%", height: "94%", backgroundColor: "black", borderRadius: 15, alignItems: "center", elevation: 4, marginBottom: 3, },
  surface3: { width: "100%", height: "100%", },
  horhor: { width: "100vw", height: "80%", backgroundColor: "red", },
  com_safeView_title_route_total_content2: {},


  bbbccc: { marginTop: 18, bottom: 0, width: "40%", marginLeft: "4%", marginBottom: "4%", borderRadius: 50, borderColor: "#555555", borderWidth: 1, backgroundColor: "white", },
  ...
  com_safeView_contents2: { flex: 11.3, justifyContent: "center", alignItems: "center", marginTop: "-2.5%", backgroundColor: "#f6f6f6", },
